    ...
    public double doExec() throws Exception {
        ...
        try {
            ...
            new ErrorStreamRedirector(solution.getErrorStream()).start();
             ...
             for (int h=targetHour;h<targetHour+1;h++) {  // awgl
                ...
                if (h>=768)
                {
                    ...
                    System.out.println("numOfRet: " + numOfRet);
                    ...
                    for (int i=idx;i<numOfRet;i++) {
                        System.out.println("ret[" + i + "]: " + ret[i] + "  |  " + ret[i] * sum);
                        ssv += ret[i]*ret[i];
                    }
                    System.out.println("sizeofNN: " + sizeofNN);
                    System.out.println("gtfIndex: " + gtfIndex);
    ...
    public static void main(String[] args) throws Exception {
       ...
       for (int i = 0; i < args.length; i++) {
            if (args[i].equals("-folder")) {
                ...
                debug = false;
            } else if (args[i].equals("-targetHour")) {
                // awgl
                targetHour = Integer.parseInt(args[++i]);
            } else {
